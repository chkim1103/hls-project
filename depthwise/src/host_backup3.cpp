    ...
    if (!valid_device) {
        ...
        exit(EXIT_FAILURE);
          ...
          OCL_CHECK(err, cl::Buffer buffer_output0(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, output_vector_size_bytes,
                                                out_hw.data(), &err));
          OCL_CHECK(err, cl::Buffer buffer_output1(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, output_vector_size_bytes,
                                                out_hw.data(), &err));
          OCL_CHECK(err, cl::Buffer buffer_output2(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, output_vector_size_bytes,
                                                out_hw.data(), &err));                                      
          OCL_CHECK(err, cl::Buffer buffer_output3(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, output_vector_size_bytes,
                                                out_hw.data(), &err));                                      
          ...
          OCL_CHECK(err, err = krnl_depthwise.setArg(5, buffer_output0));
          OCL_CHECK(err, err = krnl_depthwise.setArg(6, buffer_output1));
          OCL_CHECK(err, err = krnl_depthwise.setArg(7, buffer_output2));
          OCL_CHECK(err, err = krnl_depthwise.setArg(8, buffer_output3));
          OCL_CHECK(err, err = krnl_depthwise.setArg(9, W));
          OCL_CHECK(err, err = krnl_depthwise.setArg(10, H));
          OCL_CHECK(err, err = krnl_depthwise.setArg(11, C));
          OCL_CHECK(err, err = krnl_depthwise.setArg(12, K));
          OCL_CHECK(err, err = krnl_depthwise.setArg(13, pad));
          OCL_CHECK(err, err = krnl_depthwise.setArg(14, stride));
         ...
         OCL_CHECK(err, err = q.enqueueMigrateMemObjects({buffer_in0, buffer_in1, buffer_in2, buffer_in3,buffer_kernel}, 0 ));/* 0 means from host*/
          ...
          OCL_CHECK(err, err = q.enqueueMigrateMemObjects({buffer_output0,buffer_output1,buffer_output2,buffer_output3,}, CL_MIGRATE_MEM_OBJECT_HOST));
